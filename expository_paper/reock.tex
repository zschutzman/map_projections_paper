...
\mute{The similarity of this measure to the convex hull score suggest a similar tack for proving that no map projection can preserve the ordering of Reock scores, and indeed the structure of the proof is identical.  We proceed by demonstrating the following:
