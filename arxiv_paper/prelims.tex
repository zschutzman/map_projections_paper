...
An astute reader may notice that this result is also true of planar triangles, and the planar version follows from Propositions I.6 and I.8 in Euclid's \textit{Elements} \cite{elements}.  Since Euclid's proof doesn't rely on the existence of parallel lines, this fact can alternatively be shown using his argument.
