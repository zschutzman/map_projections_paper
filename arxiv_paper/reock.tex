...
This inequality follows from the fact that $\tan(\theta)$ is convex on the relevant interval, \footnote{Equivalently, since $\tan(\theta)$ is differentiable, we can observe that the second derivative of $\tan(\theta)$ is positive on this interval.} $0<\theta<\tfrac{\pi}{2}$.
