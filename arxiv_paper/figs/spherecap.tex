...
\draw [shift={(0,0)},line width=2.1pt]  plot[domain=0:3.141592653589793,variable=\t]({1*4*cos(\t r)+0*4*sin(\t r)},{0*4*cos(\t r)+1*4*sin(\t r)});
...
\draw [fill=ududff] (0.0016366799970421299,9.441278259356354) circle (2.2pt);

\draw [fill=ududff] (0.019848790872865698,-6.481795867514522) circle (2.2pt);
