...
\draw [line width=3.6pt,fill=black,fill opacity=0.4] (2.52,-1.24) circle (5.094349811310566cm);
...
\draw (-0.84942211242749375,1.2652523257265278) node[anchor=north west] {\LARGE$A$};
